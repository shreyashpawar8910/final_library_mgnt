...
<body>
    		...
    		<script type="text/javascript">
    		 ...
    		 var msggg = "<%=msgget %>";
    		 	...
    		 	if(msggg=="delete faild"){
    		 		...
    		 		swal("Error", "Journal Delete Unsucessfull", "error");
	...
	<table class="table table-bordered" id="table1">
		...
		<tbody>
			...
			List<Original_journal_enti> list = Or_jr_dao.get_search_or_journal(serch_table, serch_cont);
			...
			%>
				...
				<tr>			
					...
					&nbsp;&nbsp;&nbsp;
					<a href="single_journal_delet?single_journal_id=<%=or_jr.getJournal_id()%>" style="color: red;">Delete</a></td>
				</tr>
			...
			<!-- This Hidden table for Print Data into Pdf  -->
		...
		<tbody>
			...
			List<Original_journal_enti> list1 =  Or_jr_dao.get_search_or_journal(serch_table, serch_cont);
...
<script type="text/javascript">
	...
	function generate() {  
	    ...
	    if(tab=="or_jr_id"){
	    	...
	    	doc.text(122, y = y + 10, "ID Wise Journal");	
	    }else if(tab=="or_jr_title"){
	    	
	    	doc.text(118, y = y + 10, "Title Wise Journal");	
	    }else if(tab=="or_jr_auther_name"){
	    	
	    	doc.text(118, y = y + 10, "Title Wise Journal");	
	    }else if(tab=="or_jr_dept"){
	    	
	    	doc.text(108, y = y + 10, "Department Wise Journal");	
	    }else if(tab=="or_jr_language"){
	    	
	    	doc.text(108, y = y + 10, "Language Wise Journal");	
	    };
