...
<title>Transaction Reports of Students</title>
...
<body>
	...
	<div class="tr_stud_container">
		...
		<div class="page_haiding">
			<h3>Students Transaction Reports</h3>
		</div>
		
		
		<form action="Search_tran_report_student.jsp" method="get">
		<div class="row_design"><br>
		<div class="row">
			<div class="col"><select name="search_table_name">
				
				<option value="tr_stud_stud_id">Student ID</option>				
				<option value="tr_stud_name">Student Name</option>
