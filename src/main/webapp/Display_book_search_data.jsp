...
<body>
	...
	<table class="table table-bordered" id="table1">
		...
		<tbody>
			...
			List<Original_book_enti> list = Or_book_dao.get_search_or_books(serch_table, serch_cont);
	...
	<!-- This Hidden table for print data in pdf  -->
	
	
	
	<table id="bookTable" class="table table-bordered"  hidden>
		<thead>
			<th>ID</th>
			<th>Title</th>
			<th>Author</th>
		...
		<tbody>
			...
			List<Original_book_enti> list1 = Or_book_dao.get_search_or_books(serch_table, serch_cont);
...
function generate() {  
	    ...
	    if(tab=="or_b_id"){
	    	...
	    	doc.text(125, y = y + 10, "ID Wise Books");
	    	
	    }else if(tab=="or_b_title"){
	    	
	    	doc.text(120, y = y + 10, "Title Wise Books");
	    	
	    }else if(tab=="or_b_author_nm"){
	    	
	    	doc.text(120, y = y + 10, "Author Wise Books");
	    	
	    }else if(tab=="or_b_department"){
	    	
	    	doc.text(111, y = y + 10, "Department Wise Books");
	    	
	    }else if(tab=="or_b_language"){
	    	
	    	doc.text(111, y = y + 10, "Language Wise Books");
