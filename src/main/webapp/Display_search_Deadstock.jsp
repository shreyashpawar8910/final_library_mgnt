	...
	<table class="table table-bordered" id="table2">
		...
		<tbody>
			...
			<%
				...
				List<Dead_stock_enti> list = dead_dao.get_search_dead_stock(serch_table, serch_cont);
		...
		<tbody>
			...
			<%
			List<Dead_stock_enti> list1 = dead_dao.get_search_dead_stock(serch_table, serch_cont);
	...
	<div class="overlay"></div>	
		...
		<form action="dead_stock_array_delete" method="post">
			...
			<label>Do you want to delete records ?</label><br><br>
						...
						<a href="Display_search_Deadstock.jsp"  class="btn-no" >No</a>
		</form>
		</div>
...
<script type="text/javascript">
	...
	function generate() {  
	    ...
	    if(tab=="b_dead_id"){
	    	...
	    	doc.text(120, y = y + 10, "ID Wise Dead Stock");
	    	
	    }else if(tab=="b_dead_title"){
	    	
	    	doc.text(115, y = y + 10, "Title Wise Dead Stock");
	    	
	    }else if(tab=="b_dead_author"){
	    	
	    	doc.text(115, y = y + 10, "Author Wise Dead Stock");
	    	
	    }else if(tab=="b_dead_dept"){
	    	
	    	doc.text(107, y = y + 10, "Department Wise Dead Stock");	
	    	
	    }else if(tab=="b_dead_stock_cat"){
	    	
	    	doc.text(107, y = y + 10, "Category Wise Dead Stock");	
	    }
	    ...
	    doc.save('Search Dead Stocks.pdf');  
	}  
