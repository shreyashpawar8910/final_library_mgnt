...
<title>Display student search</title>
...
<body>
	...
	<table class="table table-bordered" id="table1">
		...
		<tbody>
			...
			List<Student_enti> list = dao.get_search_student(serch_table, serch_cont);
		...
		<tbody>
			...
			List<Student_enti> list4 = dao.get_search_student(serch_table, serch_cont);
	...
	<div class="overlay"></div>	
		...
		<div class="row">
			<div class="col"><input type="text" id="edit_student_id" readonly name="stud_id" required="required" > </div>
			<div class="col"><input type="text" id="edit_student_name"  name="stud_name" required="required" > </div>
			
			
				<div class="col"><select  name="stud_dept" id="edit_student_dept" required="required" >
		...
		<div class="row">
			<div class="col"><input type="text" id="edit_student_class" name="stud_class" required="required"> </div>
			<div class="col"><input type="date" id="edit_student_dob" required="required"> </div>
			<div class="col"><input type="text" id="edit_student_city" name="stud_city" required="required"> </div>
		</div>
		...
		<div class="row">
			<div class="col"><input type="text" id="edit_student_taluka" name="stud_taluka" required="required" > </div>
			<div class="col"><input type="text" id="edit_student_dist" name="stud_dist" required="required"> </div>
			<div class="col"><input type="number" id="edit_student_phone" name="stud_phone" required="required"> </div>
		</div>	
		...
		<div class="row">
			<div class="col"><input type="email" id="edit_student_email" name="stud_email" required="required" > </div>
			<div class="col"><input  type="file" name="stud_photo" id="edit_student_photo" required="required" style="padding: 5px; height: 40px;"> </div>
		</div>
...
function generate() { 
 ...
 if(tab=="stud_dept"){
	 ...
	 doc.text(111, y = y + 10, "Student Department : "+cont);

 }else if(tab=="stud_class"){
	 
	 doc.text(127, y = y + 10, "Class : "+cont);
	 
 }else{
	 
	 doc.text(130, y = y+10, "Students");
