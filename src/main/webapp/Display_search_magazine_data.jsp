...
<title>Display Search Magazine Data</title>
...
<body>
	...
	<table class="table table-bordered" id="table1">
		...
		<tbody>
			...
			List<Magazine_enti> list = Or_mag_dao.get_search_or_magzine(serch_table, serch_cont);
		...
		<table id="magTable" class="table table-bordered" hidden>
		<thead>
		...
		<%
			...
			List<Magazine_enti> list1 =  Or_mag_dao.get_search_or_magzine(serch_table, serch_cont);
...
<script type="text/javascript">
	...
	function generate() {  
	    ...
	    if(tab=="or_mag_id"){
	    	...
	    	doc.text(122, y = y + 10, "ID Wise Magazine");
	    	
	    }else if(tab=="or_mag_title"){
	    	
	    	doc.text(117, y = y + 10, "Title Wise Magazine");
	    	
	    }else if(tab=="or_mag_author"){
	    	
	    	doc.text(117, y = y + 10, "Author Wise Magazine");
	    	
	    }else if(tab=="or_mag_dept"){
	    	
	    	doc.text(109, y = y + 10, "Department Wise Magazine");	
	    	
	    }else if(tab=="or_mag_language"){
	    	
	    	doc.text(109, y = y + 10, "Language Wise Magazine");	
	    }
	    
	    
	    
	    //doc.text(130, y = y + 10, "Total Books");
