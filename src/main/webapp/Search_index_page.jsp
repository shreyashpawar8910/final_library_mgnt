...
<div class="home_page_container">
	...
	<br><br>
	 <div class="container">
		...
		<%
			String content = request.getParameter("search_field");
		
			Original_bookDAO Or_book_dao = new Original_bookDAO(DBConnect.getConn());
			List<Original_book_enti> list = Or_book_dao.getall_or_only_books(content);
            ...
            <div class="card-body">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                        <input type="text" class="form-control form-control-sm" value="Category :  Book" readonly>
                    </div>
	...
	<!-- **************************************************************** -->
	<!-- ************** For Display Data of Searched Journal ************* -->
			...
			List<Original_journal_enti> list1 = Or_book_dao.getall_or_journal(content);
            ...
            <div class="card-body">
                ...
                <h5><%=or_jr.getJournal_title() %></h5>
                <p><%=or_jr.getJournal_author() %></p>
                <br>
                <div class="form-row">
                    <div class="form-group col-md-3">
                        <input type="text" class="form-control form-control-sm" value="Publication :  <%=or_jr.getSearch_publisher() %>" readonly>
                    </div>
                    
                    <div class="form-group col-md-3">
                        <input type="text" class="form-control form-control-sm" value="Publisher Year :  <%=or_jr.getJournal_publi_year() %>" readonly>
                    </div>
                    
                    <div class="form-group col-md-3">
                        <input type="text" class="form-control form-control-sm" value="Edition : <%=or_jr.getJournal_edition() %>" readonly>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-3">
                        <input type="text" class="form-control form-control-sm" value="Language :  <%=or_jr.getJournal_language() %>" readonly>
                    </div>
                    
                    <div class="form-group col-md-3">
                        <input type="text" class="form-control form-control-sm" value="Location :  <%=or_jr.getJournal_rack_no() %>" readonly>
                    </div>
                    
                    <div class="form-group col-md-3">
                        <input type="text" class="form-control form-control-sm" value="Category :  Journal" readonly>
                    </div>
                ...
                <%
						if(or_jr.getJournal_status().equals("available")){
				%>
                    
                <h6>Status : <b style="color: green"> <%=or_jr.getJournal_status() %></b></h6>      
                        
                <%}else{ %>
                
                
                    
                <h6>Status : <b style="color: red"> <%=or_jr.getJournal_status() %></b></h6>      
	...
	<!-- ************** For Display Data of Searched Journal ************* -->
			...
			List<Magazine_enti> list2 = Or_book_dao.getall_or_magzine(content);
			
			
			for(Magazine_enti or_mag:list2){
            ...
            <div class="card-body">
                ...
                <h5><%=or_mag.getMag_title() %></h5>
                <p><%=or_mag.getMag_author() %></p>
                <br>
                <div class="form-row">
                    <div class="form-group col-md-3">
                        <input type="text" class="form-control form-control-sm" value="Publication :  <%=or_mag.getSearch_publisher() %>" readonly>
                    </div>
                    
                    <div class="form-group col-md-3">
                        <input type="text" class="form-control form-control-sm" value="Publisher Year :  <%=or_mag.getMag_publi_year() %>" readonly>
                    </div>
                    
                    <div class="form-group col-md-3">
                        <input type="text" class="form-control form-control-sm" value="Edition : <%=or_mag.getMag_edition() %>" readonly>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-3">
                        <input type="text" class="form-control form-control-sm" value="Language :  <%=or_mag.getMag_language() %>" readonly>
                    </div>
                    
                    <div class="form-group col-md-3">
                        <input type="text" class="form-control form-control-sm" value="Location :  <%=or_mag.getMag_rack_no() %>" readonly>
                    </div>
                    
                     <div class="form-group col-md-3">
                        <input type="text" class="form-control form-control-sm" value="Category :  Magazine" readonly>
                    </div>
                ...
                <%
						if(or_mag.getMag_status().equals("available")){
				%>
                    
                <h6>Status : <b style="color: green"> <%=or_mag.getMag_status() %></b></h6>      
                        
                <%}else{ %>
                
                
                    
                <h6>Status : <b style="color: red"> <%=or_mag.getMag_status() %></b></h6>      
