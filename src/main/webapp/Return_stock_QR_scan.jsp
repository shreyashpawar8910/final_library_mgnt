...
<body>
  ...
  <div class="show_qr">
    ...
    <div class="card-2">
    	...
    	<form action="return_stock_id" class="next_form">
    		...
    		<script type="text/javascript">
    		 ...
    		 var msggg = "<%=msgget %>";
    		 	...
    		 	}else if(msggg=="not_returned"){
    		 		
    		 		swal("Error", "Book Return Faild ", "error");
    		 	
    		 	
    		 	}else if(msggg=="returned"){
    		 		
    		 		swal("Success", "Book Return Sucessfull ", "success");
    		 	}
