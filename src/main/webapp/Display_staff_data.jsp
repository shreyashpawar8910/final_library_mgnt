...
<body>
	...
	<%@include file="lbl_side_nav.jsp" %>
    		...
    		<script type="text/javascript">
    		 ...
    		 var msggg = "<%=msgget %>";
				 ...
				 if(msggg =="update success"){
					
					swal("Success", "Staff Data Update Sucessfull", "success");
					
				}else if(msggg =="update faild"){
					
					swal("Error", "Staff Data Update Faild", "error");
					
				}else if(msggg =="delete success"){
					
					swal("Success", "Staff Data Delete Sucessfull", "success");
					
				}else if(msggg =="delete faild"){
					
					swal("Error", "Staff Data Delete Faild", "error");
	...
	<div class="book_data_container">
		...
		<form action="Display_staff_search_data.jsp" method="get">
		<div class="row_design">
		<div class="row">
			<div class="col"><select name="search_table_name">
			
				<option value="stf_id">ID</option>
				<option value="stf_name">Name</option>
			
				<option value="stf_dept">Department</option>
	...
	<table class="table table-bordered" id="table1">
		...
		<tbody>
			...
			<%
				...
				List<Staff_enti> list = dao.getall_staff();
		...
		<tbody>
			...
			<%
				...
				List<Staff_enti> list2 = dao.getall_staff();
